...
use CodeKandis\Converters\Tests\DataProviders\UnitTests\BiDirectionalConverters\BooleanIntegerStringToBooleanBiDirectionalConverterInterfaceTest\BiDirectionalConvertersWithInvalidToValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
use CodeKandis\Converters\BiDirectionalConverters\BooleanIntegerStringToBooleanBiDirectionalConverterInterface;
...
/**
 * Represents the test case of `CodeKandis\Converters\BiDirectionalConverters\BooleanIntegerStringToBooleanBiDirectionalConverterInterface`.
...
{
	/**
	 * Tests if the method `BooleanIntegerStringToBooleanBiDirectionalConverterInterface::convert()` throws a `CodeKandis\Types\InvalidValueExceptionInterface` on an invalid value.
