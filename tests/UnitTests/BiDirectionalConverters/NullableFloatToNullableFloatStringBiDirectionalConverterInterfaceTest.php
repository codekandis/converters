...
use CodeKandis\Converters\Tests\DataProviders\UnitTests\BiDirectionalConverters\NullableFloatToNullableFloatStringBiDirectionalConverterInterfaceTest\BiDirectionalConvertersWithInvalidFromValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
use CodeKandis\Converters\BiDirectionalConverters\NullableFloatToNullableFloatStringBiDirectionalConverterInterface;
...
/**
 * Represents the test case of `CodeKandis\Converters\BiDirectionalConverters\NullableFloatToNullableFloatStringBiDirectionalConverterInterface`.
...
{
	/**
	 * Tests if the method `NullableFloatToNullableFloatStringBiDirectionalConverterInterface::convert()` throws a `CodeKandis\Types\InvalidValueExceptionInterface` on an invalid value.
