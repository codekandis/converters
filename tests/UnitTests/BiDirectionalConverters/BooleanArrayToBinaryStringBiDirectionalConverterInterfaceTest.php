...
use CodeKandis\Converters\Tests\DataProviders\UnitTests\BiDirectionalConverters\BooleanArrayToBinaryStringBiDirectionalConverterInterfaceTest\BiDirectionalConvertersWithInvalidFromValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider;
use CodeKandis\Converters\BiDirectionalConverters\BooleanArrayToBinaryStringBiDirectionalConverterInterface;
...
/**
 * Represents the test case of `CodeKandis\Converters\BiDirectionalConverters\BooleanArrayToBinaryStringBiDirectionalConverterInterface`.
...
{
	/**
	 * Tests if the method `BooleanArrayToBinaryStringBiDirectionalConverterInterface::convert()` throws a `CodeKandis\Types\InvalidValueExceptionInterface` on an invalid value.
