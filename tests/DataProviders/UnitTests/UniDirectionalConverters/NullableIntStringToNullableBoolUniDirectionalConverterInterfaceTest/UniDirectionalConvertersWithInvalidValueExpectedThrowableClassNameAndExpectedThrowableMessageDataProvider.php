...
namespace CodeKandis\Converters\Tests\DataProviders\UnitTests\UniDirectionalConverters\NullableIntStringToNullableBoolUniDirectionalConverterInterfaceTest;
			...
			0 => [
				...
				'expectedThrowableMessage'   => sprintf(
					...
					implode(
						...
						[
							'null',
							...Values::BOOLEAN_INTEGER_STRING_SET
						]
					)
				)
			],
