...
namespace CodeKandis\Converters\Tests\DataProviders\UnitTests\UniDirectionalConverters\StringToDateTimeUniDirectionalConverterInterfaceTest;
...
class UniDirectionalConvertersWithInvalidValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				'uniDirectionalConverter'    => new StringToDateTimeUniDirectionalConverter( $format = Values::DATETIME_FORMAT ),
