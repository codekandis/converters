...
namespace CodeKandis\Converters\Tests\DataProviders\UnitTests\UniDirectionalConverters\BooleanIntegerStringToBooleanUniDirectionalConverterInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidValueException::EXCEPTION_MESSAGE_INVALID_VALUE_AND_EXPECTED_VALUES, $invalidValue, Values::REGEX_BOOLEAN_INTEGER_STRING )
			],
			1 => [
				'uniDirectionalConverter'    => new BooleanIntegerStringToBooleanUniDirectionalConverter(),
