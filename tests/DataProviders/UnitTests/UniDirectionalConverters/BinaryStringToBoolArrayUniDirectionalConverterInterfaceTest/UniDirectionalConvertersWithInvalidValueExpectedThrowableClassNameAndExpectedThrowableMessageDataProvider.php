...
namespace CodeKandis\Converters\Tests\DataProviders\UnitTests\UniDirectionalConverters\BinaryStringToBoolArrayUniDirectionalConverterInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidValueException::EXCEPTION_MESSAGE_INVALID_VALUE_AND_EXPECTED_VALUES, $invalidValue, ValidValuesRegularExpressions::REGEX_BINARY_STRING )
			],
			1 => [
				'uniDirectionalConverter'    => new BinaryStringToBoolArrayUniDirectionalConverter(),
