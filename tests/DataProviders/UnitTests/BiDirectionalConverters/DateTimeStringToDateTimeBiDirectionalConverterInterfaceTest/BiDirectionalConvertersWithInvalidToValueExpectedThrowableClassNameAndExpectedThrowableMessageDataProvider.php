...
namespace CodeKandis\Converters\Tests\DataProviders\UnitTests\BiDirectionalConverters\DateTimeStringToDateTimeBiDirectionalConverterInterfaceTest;
...
class BiDirectionalConvertersWithInvalidToValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				'biDirectionalConverter'     => new DateTimeStringToDateTimeBiDirectionalConverter( $format = Values::DATETIME_FORMAT ),
			...
			5  => [
				'biDirectionalConverter'     => new DateTimeStringToDateTimeBiDirectionalConverter( $format = Values::DATETIME_FORMAT, Values::NULL ),
				'invalidToValue'             => $invalidToValue = Values::BOOLEAN_STRING_FALSE,
				'expectedThrowableClassName' => InvalidValueException::class,
				'expectedThrowableMessage'   => sprintf(
					InvalidValueException::EXCEPTION_MESSAGE_INVALID_VALUE_AND_EXPECTED_VALUES,
