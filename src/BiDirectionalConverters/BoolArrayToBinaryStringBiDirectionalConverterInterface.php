...
/**
 * Represents the interface of any bi-directional converter converting between `boolean array` and `binary string`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
interface BoolArrayToBinaryStringBiDirectionalConverterInterface extends BiDirectionalConverterInterface
{
	/**
