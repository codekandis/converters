...
/**
 * Represents the interface of any bidirectional converter converting a nullable boolean integer string value matching the regular expression {@link ValidValues::REGEX_BOOLEAN_INTEGER_STRING} into its corresponding nullable boolean value equal to `false` or `true` - and vice versa.
