...
/**
 * Represents a bi-directional converter converting between `nullable boolean` and `nullable string`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
class NullableBoolToNullableStringBiDirectionalConverter extends AbstractConverter implements NullableBoolToNullableStringBiDirectionalConverterInterface
{
	/**
	 * @inheritDoc
	 */
