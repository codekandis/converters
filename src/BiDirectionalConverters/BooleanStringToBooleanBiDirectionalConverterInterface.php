...
/**
 * Represents the interface of any bidirectional converter converting a boolean string value matching the regular expression [`ValidValuesRegularExpressions::REGEX_BOOLEAN_STRING`] into its corresponding boolean value equal to `false` or `true` - and vice versa.
...
interface BooleanStringToBooleanBiDirectionalConverterInterface extends BiDirectionalConverterInterface
{
	...
	/**
	 * Converts from boolean value equal to `false` or `true` into its corresponding a boolean string value matching the regular expression [`ValidValuesRegularExpressions::REGEX_BOOLEAN_STRING`].
