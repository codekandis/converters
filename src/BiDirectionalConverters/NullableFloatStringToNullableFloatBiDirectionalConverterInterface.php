...
/**
 * Represents the interface of any bidirectional converter converting a nullable float string value matching the regular expression {@link ValidValues::REGEX_FLOAT_STRING} into its corresponding nullable float value - and vice versa.
