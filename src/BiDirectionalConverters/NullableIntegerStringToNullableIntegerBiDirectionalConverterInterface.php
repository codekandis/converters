...
/**
 * Represents the interface of any bidirectional converter converting a nullable integer string value matching the regular expression {@link ValidValues::REGEX_INTEGER_STRING} into its corresponding nullable integer value - and vice versa.
