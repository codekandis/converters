...
/**
 * Represents a bidirectional converter converting an integer string value matching the regular expression {@link ValidValues::REGEX_INTEGER_STRING} into its corresponding integer value - and vice versa.
