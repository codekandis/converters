...
/**
 * Represents a bidirectional converter converting a boolean integer string value matching the regular expression {@link ValidValues::REGEX_BOOLEAN_INTEGER_STRING} into its corresponding boolean value equal to `false` or `true` - and vice versa.
