...
/**
 * Represents a bidirectional converter converting between `DateTimeImmutable` and `DateTime string`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
class DateTimeImmutableToDateTimeStringBiDirectionalConverter extends AbstractDateTimeRelatedConverter implements DateTimeImmutableToDateTimeStringBiDirectionalConverterInterface
{
	/**
	 * @inheritDoc
	 */
