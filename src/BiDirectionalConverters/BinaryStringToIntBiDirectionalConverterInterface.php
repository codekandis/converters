...
/**
 * Represents the interface of any bidirectional converter converting between `binary string` and `integer`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
interface BinaryStringToIntBiDirectionalConverterInterface extends BiDirectionalConverterInterface
{
	/**
