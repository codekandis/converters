...
/**
 * Represents the interface of any bidirectional converter converting a nullable boolean integer value equal to `0` or `1` into its corresponding nullable boolean value equal to `false` or `true` - and vice versa.
