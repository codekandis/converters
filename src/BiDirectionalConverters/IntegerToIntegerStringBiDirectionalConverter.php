...
/**
 * Represents a bidirectional converter converting an integer value into its corresponding integer string value matching the regular expression `ValidValuesRegularExpressions::REGEX_INTEGER_STRING` - and vice versa.
