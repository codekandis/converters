...
/**
 * Represents the interface of any bidirectional converter converting between `string` and `DateTime`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
interface StringToDateTimeBiDirectionalConverterInterface extends BiDirectionalDateTimeRelatedConverterInterface
{
	/**
