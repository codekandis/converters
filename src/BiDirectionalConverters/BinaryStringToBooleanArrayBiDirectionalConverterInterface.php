...
/**
 * Represents the interface of any bidirectional converter converting a binary string value matching the regular expression {@link ValidValues::REGEX_BINARY_STRING} into its corresponding boolean array containing values equal to `false` or `true` - and vice versa.
