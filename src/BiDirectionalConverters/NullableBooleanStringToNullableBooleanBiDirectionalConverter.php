 ...
 */
class NullableBooleanStringToNullableBooleanBiDirectionalConverter extends AbstractConverter implements NullableBooleanStringToNullableBooleanBiDirectionalConverterInterface
{
	/**
	 * @inheritDoc
	 */
