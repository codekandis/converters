...
/**
 * Represents a bidirectional converter converting a nullable float value into its corresponding nullable float string value matching the regular expression {@link ValidValues::REGEX_FLOAT_STRING} - and vice versa.
