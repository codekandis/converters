...
/**
 * Represents the interface of any bidirectional converter converting between `nullable string` and `nullable float`.
 * @package codekandis/converters
 * @author Christian Ramelow <info@codekandis.net>
 */
interface NullableStringToNullableFloatBiDirectionalConverterInterface extends BiDirectionalConverterInterface
{
	/**
