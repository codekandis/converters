...
/**
 * Represents the interface of any unidirectional converter converting an integer value into its corresponding integer string value matching the regular expression `ValidValuesRegularExpressions::REGEX_INTEGER_STRING`.
