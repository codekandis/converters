...
/**
 * Represents the interface of any unidirectional converter converting a boolean string value matching the regular expression `ValidValuesRegularExpressions::REGEX_BOOLEAN_STRING` into its corresponding boolean value equal to `false` or `true`.
