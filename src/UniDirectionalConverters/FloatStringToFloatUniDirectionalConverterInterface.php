...
/**
 * Represents the interface of any unidirectional converter converting a float string value matching the regular expression `ValidValuesRegularExpressions::REGEX_FLOAT_STRING` into its corresponding float value.
