...
/**
 * Represents the interface of any unidirectional converter converting an integer string value matching the regular expression `ValidValuesRegularExpressions::REGEX_INTEGER_STRING` into its corresponding integer value.
