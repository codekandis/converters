...
/**
 * Represents a unidirectional converter converting a nullable integer string value matching the regular expression {@link ValidValues::REGEX_INTEGER_STRING} into its corresponding nullable integer value.
...
class NullableIntegerStringToNullableIntegerUniDirectionalConverter extends AbstractConverter implements NullableIntegerStringToNullableIntegerUniDirectionalConverterInterface
{
	...
	public function convert( mixed $value ): ?int
	{
		...
		try
		{
			...
			{
				throw $this->getInvalidValueException( $value, ValidValues::NULL_STRING, ValidValues::REGEX_INTEGER_STRING );
			}
		}
