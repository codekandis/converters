...
/**
 * Represents the interface of any unidirectional converter converting a `nullable boolean integer string` into a `nullable boolean`.
...
interface NullableBooleanIntegerStringToNullableBooleanUniDirectionalConverterInterface extends UniDirectionalConverterInterface
{
	 ...
	 * @param ?string $value The `nullable integer boolean string` value which has to be converted.
